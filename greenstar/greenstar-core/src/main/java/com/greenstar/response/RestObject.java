package com.greenstar.response;
...
public class RestObject implements Serializable {
    ...
    /*
     * 返回码总体说明： ret = 0: 正确返回 ret > 0: 调用OpenAPI时发生错误，需要开发者进行相应的处理。 -50 <= ret <= -1: 接口调用不能通过接口代理机校验，需要开发者进行相应的处理。 ret <-50:
    ...
    /****** 零售商禁止访问 ******/
    public final static int STATUS_RETAILER_DISABLED_LOGIN = 1013;
    ...
    public static RestObject newOk(String message, Object data,long totalElements) {
