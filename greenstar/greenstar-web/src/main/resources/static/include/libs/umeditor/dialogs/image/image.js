(function () {
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="avatar" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
            '</div>',
        ...
        config: function (sel) {
            ...
            //url=url + (url.indexOf("?") == -1 ? "?" : "&") + "ownerId=123456&imageBase64=12321312";//初始form提交地址;
 
            $("form", $(sel, me.dialog)).attr("action", url + "?fileKey=2");
        ...
        uploadComplete: function(r){
            ...
            try{
            	...
            	//r = r.replace("</pre>","");
                var json = eval('('+r+')');
                Base.callback(me.editor, me.dialog, json.showFilePath, json.message);
            }catch (e){
        ...
        submit: function (callback) {
            ...
            var me = this,
                input = $( '<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="avatar" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
                input = input[0];
